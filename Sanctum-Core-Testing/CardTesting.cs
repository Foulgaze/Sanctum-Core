...
namespace Sanctum_Core_Testing
{
    public class CardTesting
    {
        ...
        [Test]
        public void CardParsing_LoadingCards_Test()
        {
            Assert.IsNotNull(CardData.GetCardInfo("Plains"));
            Assert.IsNotNull(CardData.GetCardInfo("Island"));
            Assert.IsNotNull(CardData.GetCardInfo("Swamp"));
            Assert.IsNotNull(CardData.GetCardInfo("Mountain"));
            Assert.IsNotNull(CardData.GetCardInfo("Forest"));
        }
